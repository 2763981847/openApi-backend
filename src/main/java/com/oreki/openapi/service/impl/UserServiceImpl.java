...
import static com.oreki.openapi.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "oreki";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String secretKey = DigestUtil.md5Hex(SALT + userPassword + RandomUtil.randomString(5));
            // 4. 插入数据
            User user = new User();
